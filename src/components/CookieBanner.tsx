    ...
    <div className="fixed bottom-0 left-0 right-0 z-[9999] bg-white border-t border-gray-200 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] p-4 md:p-6 animate-in slide-in-from-bottom-full duration-500">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex-1 flex flex-col md:flex-row items-start md:items-center gap-4">
          <div className="p-3 bg-[#1D63B7]/10 text-[#1D63B7] rounded-full shrink-0 hidden md:block">
            <Cookie size={28} />
          </div>
          <div>
            <h3 className="font-bold text-[#181A2C] text-lg mb-1 flex items-center gap-2">
              <Cookie size={20} className="md:hidden text-[#1D63B7]" />
            ...
            <p className="text-gray-600 text-sm leading-relaxed max-w-4xl">
              ...
              Az "Elfogadom" gombra kattintva Ön hozzájárul az összes süti használatához. A beállításokat bármikor módosíthatja böngészőjében. Részletes információkért olvassa el az <Link href="/adatvedelem" className="text-[#3AC2FE] hover:underline font-medium">Adatvédelmi Nyilatkozatunkat</Link>.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto shrink-0">
          ...
          <button 
            onClick={acceptAll}
            className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-[#1D63B7] text-white font-bold hover:bg-[#3AC2FE] transition-colors shadow-md flex items-center justify-center gap-2"
          >
